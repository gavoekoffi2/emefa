...
package ai.progenius.emefa.agent.knowledge
 ...
 *
 * Vault root: /storage/emulated/0/Android/data/ai.progenius.emefa/files/vault/
 *
...
object KBManager {
    ...
    private fun vaultDir(): File {
        val dir = File(EmefaApplication.instance.getExternalFilesDir(null), VAULT_SUBDIR)
