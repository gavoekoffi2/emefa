...
package ai.progenius.emefa.floating
...
object FloatingCircleManager {
    ...
    private var currentTokenState: ai.progenius.emefa.agent.TokenMonitor.State = ai.progenius.emefa.agent.TokenMonitor.State.NORMAL
     ...
     */
    fun updateTokenStatus(step: Int, formattedTokens: String, formattedCost: String, tokenState: ai.progenius.emefa.agent.TokenMonitor.State) {
        ThreadUtils.runOnUiThread {
            currentRound = step
            ...
            val colorRes = when (tokenState) {
                ai.progenius.emefa.agent.TokenMonitor.State.NORMAL -> R.color.colorBrandPrimary
                ai.progenius.emefa.agent.TokenMonitor.State.CAUTION -> R.color.colorWarningPrimary
                ai.progenius.emefa.agent.TokenMonitor.State.WARNING -> R.color.colorWarningPrimary
                ai.progenius.emefa.agent.TokenMonitor.State.CRITICAL -> R.color.colorErrorPrimary
            }
            try {
