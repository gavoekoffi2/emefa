...
import ai.progenius.emefa.agent.CloudModel
import ai.progenius.emefa.agent.CloudProvider
import ai.progenius.emefa.agent.ModelPricing
import ai.progenius.emefa.agent.llm.ActiveModelMode
import ai.progenius.emefa.agent.llm.LocalModelManager
...
import ai.progenius.emefa.widget.KButton
...
class LlmConfigActivity : BaseActivity() {
                        ...
                        val useBtn = TextView(this).apply {
                            ...
                            setOnClickListener {
                                ...
                                if (path != null) {
                                    ...
                                    EmefaApplication.appViewModelInstance.updateAgentConfig()
                                    EmefaApplication.appViewModelInstance.initAgent()
    ...
    private fun setupCloudLlm(tc: ThemeManager.ChatColors) {
        ...
        btnSave.setOnClickListener {
            ...
            EmefaApplication.appViewModelInstance.updateAgentConfig()
            EmefaApplication.appViewModelInstance.initAgent()
            EmefaApplication.appViewModelInstance.afterInit()
