 ...
 *
 * Storage: /storage/emulated/0/EMEFA/chats/
...
object ChatHistoryManager {
    ...
    private const val MESSAGE_TIMESTAMP_PREFIX = "<!-- emefa:timestamp="
    ...
    fun rename(file: File, newTitle: String): Boolean {
        ...
        try {
            ...
            ai.progenius.emefa.utils.XLog.e("ChatHistoryManager", "Failed to rename conversation", e)
            return false
        }
    }
