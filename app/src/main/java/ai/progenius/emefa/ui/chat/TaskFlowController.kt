...
import ai.progenius.emefa.agent.DirectDeviceDataGuard
import ai.progenius.emefa.agent.PipelineRouter
import ai.progenius.emefa.agent.TaskPromptEnvelope
...
class TaskFlowController(
    ...
    fun startMonitor(target: MonitorTargetSpec, typedInput: String? = null) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            XLog.i(TAG, "startMonitor: monitor active, staying in EMEFA")
        }, 1500)
    }
    ...
    private fun checkAutoReplyConfirmation() {
        ...
        XLog.i(TAG, "checkAutoReplyConfirmation: monitor active, staying in EMEFA")
    }
