...
class ForegroundService : Service() {
    ...
    companion object {
        ...
        const val CHANNEL_ID = "EMEFA_foreground_channel"
        const val NOTIFICATION_ID = 1001
        private const val EXTRA_TITLE = "extra_title"
        private const val EXTRA_TEXT = "extra_text"
        private const val DEFAULT_TASK_TITLE = "EMEFA · Task in progress"
        private const val DEFAULT_TASK_TEXT = "Running task..."
        private const val DEFAULT_MONITOR_TITLE = "EMEFA · Monitoring"
        private const val DEGRADED_MONITOR_TITLE = "EMEFA · Monitoring paused"
        ...
        private fun buildNotification(context: Context, title: String, text: String): Notification {
            val intent = Intent(context, ai.progenius.emefa.ui.chat.ComposeChatActivity::class.java)
